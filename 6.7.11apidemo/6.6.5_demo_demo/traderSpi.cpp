...
void CTraderSpi::OnRspOrderAction(CThostFtdcInputOrderActionField* pInputOrderAction, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (pInputOrderAction)
	{
		...
		LOG("\tSessionReqSeq [%d]\n", pInputOrderAction->SessionReqSeq);
...
void CTraderSpi::OnRspQuoteAction(CThostFtdcInputQuoteActionField* pInputQuoteAction, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (pInputQuoteAction)
	{
		...
		LOG("\tSessionReqSeq [%d]\n", pInputQuoteAction->SessionReqSeq);
...
void CTraderSpi::OnRspQryInvestorPosition(CThostFtdcInvestorPositionField* pInvestorPosition, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (pInvestorPosition)
	{
		...
		LOG("\tTasPositionCost [%.8lf]\n", pInvestorPosition->TasPositionCost);
		LOG("\tOptionValue [%.8lf]\n", pInvestorPosition->OptionValue);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
void CTraderSpi::OnRspQryInvestor(CThostFtdcInvestorField* pInvestor, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (pInvestor)
	{
		...
		LOG("\tIsOrderFreq [%c]\n", pInvestor->IsOrderFreq);
		LOG("\tIsOpenVolLimit [%c]\n", pInvestor->IsOpenVolLimit);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
void CTraderSpi::OnRspQryUserSession(CThostFtdcUserSessionField* pUserSession, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	LOG("<OnRspQryUserSession>\n");
	if (pUserSession)
	{
		LOG("\tBrokerID [%s]\n", pUserSession->BrokerID);
		LOG("\tUserID [%s]\n", pUserSession->UserID);
		LOG("\tLoginDate [%s]\n", pUserSession->LoginDate);
		LOG("\tLoginTime [%s]\n", pUserSession->LoginTime);
		LOG("\treserve1 [%s]\n", pUserSession->reserve1);
		LOG("\tUserProductInfo [%s]\n", pUserSession->UserProductInfo);
		LOG("\tInterfaceProductInfo [%s]\n", pUserSession->InterfaceProductInfo);
		LOG("\tProtocolInfo [%s]\n", pUserSession->ProtocolInfo);
		LOG("\tMacAddress [%s]\n", pUserSession->MacAddress);
		LOG("\tLoginRemark [%s]\n", pUserSession->LoginRemark);
		LOG("\tIPAddress [%s]\n", pUserSession->IPAddress);
...
void CTraderSpi::OnRspQryProduct(CThostFtdcProductField* pProduct, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (pProduct)
	{
		...
		LOG("\tOpenLimitControlLevel [%c]\n", pProduct->OpenLimitControlLevel);
		LOG("\tOrderFreqControlLevel [%c]\n", pProduct->OrderFreqControlLevel);
		LOG("\tPriceTick [%.8lf]\n", pProduct->PriceTick);
...
{
	LOG("<OnRspQryTraderOffer>\n");
	if (pTraderOffer)
	{
		LOG("\tExchangeID [%s]\n", pTraderOffer->ExchangeID);
		LOG("\tTraderID [%s]\n", pTraderOffer->TraderID);
		LOG("\tParticipantID [%s]\n", pTraderOffer->ParticipantID);
		LOG("\tPassword [%s]\n", pTraderOffer->Password);
		LOG("\tOrderLocalID [%s]\n", pTraderOffer->OrderLocalID);
		LOG("\tConnectRequestDate [%s]\n", pTraderOffer->ConnectRequestDate);
		LOG("\tConnectRequestTime [%s]\n", pTraderOffer->ConnectRequestTime);
		LOG("\tLastReportDate [%s]\n", pTraderOffer->LastReportDate);
		LOG("\tLastReportTime [%s]\n", pTraderOffer->LastReportTime);
		LOG("\tConnectDate [%s]\n", pTraderOffer->ConnectDate);
		LOG("\tConnectTime [%s]\n", pTraderOffer->ConnectTime);
		LOG("\tStartDate [%s]\n", pTraderOffer->StartDate);
		LOG("\tStartTime [%s]\n", pTraderOffer->StartTime);
		LOG("\tTradingDay [%s]\n", pTraderOffer->TradingDay);
		LOG("\tBrokerID [%s]\n", pTraderOffer->BrokerID);
		LOG("\tMaxTradeID [%s]\n", pTraderOffer->MaxTradeID);
		LOG("\tMaxOrderMessageReference [%s]\n", pTraderOffer->MaxOrderMessageReference);
		LOG("\tInstallID [%d]\n", pTraderOffer->InstallID);
		LOG("\tTraderConnectStatus [%c]\n", pTraderOffer->TraderConnectStatus);
		LOG("\tOrderCancelAlg [%c]\n", pTraderOffer->OrderCancelAlg);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
void CTraderSpi::OnRspQryInvestorPositionCombineDetail(CThostFtdcInvestorPositionCombineDetailField* pInvestorPositionCombineDetail, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (pInvestorPositionCombineDetail)
	{
		...
		LOG("\treserve1 [%s]\n", pInvestorPositionCombineDetail->reserve1);
		LOG("\treserve2 [%s]\n", pInvestorPositionCombineDetail->reserve2);
...
void CTraderSpi::OnRspQryInvestorProductGroupMargin(CThostFtdcInvestorProductGroupMarginField* pInvestorProductGroupMargin, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	{
		LOG("\treserve1 [%s]\n", pInvestorProductGroupMargin->reserve1);
...
void CTraderSpi::OnRspQryExchangeMarginRateAdjust(CThostFtdcExchangeMarginRateAdjustField* pExchangeMarginRateAdjust, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (pExchangeMarginRateAdjust)
	{
		...
		LOG("\treserve1 [%s]\n", pExchangeMarginRateAdjust->reserve1);
...
void CTraderSpi::OnRspQryProductGroup(CThostFtdcProductGroupField* pProductGroup, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	if (pProductGroup)
	{
		LOG("\treserve1 [%s]\n", pProductGroup->reserve1);
		LOG("\tExchangeID [%s]\n", pProductGroup->ExchangeID);
		LOG("\treserve2 [%s]\n", pProductGroup->reserve2);
...
void CTraderSpi::OnRspQryMMInstrumentCommissionRate(CThostFtdcMMInstrumentCommissionRateField* pMMInstrumentCommissionRate, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	{
		LOG("\treserve1 [%s]\n", pMMInstrumentCommissionRate->reserve1);
...
void CTraderSpi::OnRspQryMMOptionInstrCommRate(CThostFtdcMMOptionInstrCommRateField* pMMOptionInstrCommRate, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	{
		LOG("\treserve1 [%s]\n", pMMOptionInstrCommRate->reserve1);
...
void CTraderSpi::OnRspQryInstrumentOrderCommRate(CThostFtdcInstrumentOrderCommRateField* pInstrumentOrderCommRate, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	...
	{
		LOG("\treserve1 [%s]\n", pInstrumentOrderCommRate->reserve1);
		...
		LOG("\tOrderCommByTrade [%.8lf]\n", pInstrumentOrderCommRate->OrderCommByTrade);
		LOG("\tOrderActionCommByTrade [%.8lf]\n", pInstrumentOrderCommRate->OrderActionCommByTrade);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
void CTraderSpi::OnRtnErrorConditionalOrder(CThostFtdcErrorConditionalOrderField* pErrorConditionalOrder)
{
	...
	if (pErrorConditionalOrder)
	{
		...
		LOG("\treserve1 [%s]\n", pErrorConditionalOrder->reserve1);
		...
		LOG("\treserve2 [%s]\n", pErrorConditionalOrder->reserve2);
		...
		LOG("\treserve3 [%s]\n", pErrorConditionalOrder->reserve3);
...
{
	LOG("<OnRspQryClassifiedInstrument>\n");
	if (pInstrument)
	{
		LOG("\treserve1 [%s]\n", pInstrument->reserve1);
		LOG("\tExchangeID [%s]\n", pInstrument->ExchangeID);
...
{
	LOG("<OnRspQryCombPromotionParam>\n");
	if (pCombPromotionParam)
	{
		LOG("\tExchangeID [%s]\n", pCombPromotionParam->ExchangeID);
		LOG("\tInstrumentID [%s]\n", pCombPromotionParam->InstrumentID);
		LOG("\tCombHedgeFlag [%s]\n", pCombPromotionParam->CombHedgeFlag);
		LOG("\tXparameter [%.8lf]\n", pCombPromotionParam->Xparameter);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRiskSettleInvstPosition>\n");
	if (pRiskSettleInvstPosition)
	{
		LOG("\tInstrumentID [%s]\n", pRiskSettleInvstPosition->InstrumentID);
		LOG("\tBrokerID [%s]\n", pRiskSettleInvstPosition->BrokerID);
		LOG("\tInvestorID [%s]\n", pRiskSettleInvstPosition->InvestorID);
		LOG("\tTradingDay [%s]\n", pRiskSettleInvstPosition->TradingDay);
		LOG("\tExchangeID [%s]\n", pRiskSettleInvstPosition->ExchangeID);
		LOG("\tInvestUnitID [%s]\n", pRiskSettleInvstPosition->InvestUnitID);
		LOG("\tYdPosition [%d]\n", pRiskSettleInvstPosition->YdPosition);
		LOG("\tPosition [%d]\n", pRiskSettleInvstPosition->Position);
		LOG("\tLongFrozen [%d]\n", pRiskSettleInvstPosition->LongFrozen);
		LOG("\tShortFrozen [%d]\n", pRiskSettleInvstPosition->ShortFrozen);
		LOG("\tOpenVolume [%d]\n", pRiskSettleInvstPosition->OpenVolume);
		LOG("\tCloseVolume [%d]\n", pRiskSettleInvstPosition->CloseVolume);
		LOG("\tSettlementID [%d]\n", pRiskSettleInvstPosition->SettlementID);
		LOG("\tCombPosition [%d]\n", pRiskSettleInvstPosition->CombPosition);
		LOG("\tCombLongFrozen [%d]\n", pRiskSettleInvstPosition->CombLongFrozen);
		LOG("\tCombShortFrozen [%d]\n", pRiskSettleInvstPosition->CombShortFrozen);
		LOG("\tTodayPosition [%d]\n", pRiskSettleInvstPosition->TodayPosition);
		LOG("\tStrikeFrozen [%d]\n", pRiskSettleInvstPosition->StrikeFrozen);
		LOG("\tAbandonFrozen [%d]\n", pRiskSettleInvstPosition->AbandonFrozen);
		LOG("\tYdStrikeFrozen [%d]\n", pRiskSettleInvstPosition->YdStrikeFrozen);
		LOG("\tTasPosition [%d]\n", pRiskSettleInvstPosition->TasPosition);
		LOG("\tPosiDirection [%c]\n", pRiskSettleInvstPosition->PosiDirection);
		LOG("\tHedgeFlag [%c]\n", pRiskSettleInvstPosition->HedgeFlag);
		LOG("\tPositionDate [%c]\n", pRiskSettleInvstPosition->PositionDate);
		LOG("\tLongFrozenAmount [%.8lf]\n", pRiskSettleInvstPosition->LongFrozenAmount);
		LOG("\tShortFrozenAmount [%.8lf]\n", pRiskSettleInvstPosition->ShortFrozenAmount);
		LOG("\tOpenAmount [%.8lf]\n", pRiskSettleInvstPosition->OpenAmount);
		LOG("\tCloseAmount [%.8lf]\n", pRiskSettleInvstPosition->CloseAmount);
		LOG("\tPositionCost [%.8lf]\n", pRiskSettleInvstPosition->PositionCost);
		LOG("\tPreMargin [%.8lf]\n", pRiskSettleInvstPosition->PreMargin);
		LOG("\tUseMargin [%.8lf]\n", pRiskSettleInvstPosition->UseMargin);
		LOG("\tFrozenMargin [%.8lf]\n", pRiskSettleInvstPosition->FrozenMargin);
		LOG("\tFrozenCash [%.8lf]\n", pRiskSettleInvstPosition->FrozenCash);
		LOG("\tFrozenCommission [%.8lf]\n", pRiskSettleInvstPosition->FrozenCommission);
		LOG("\tCashIn [%.8lf]\n", pRiskSettleInvstPosition->CashIn);
		LOG("\tCommission [%.8lf]\n", pRiskSettleInvstPosition->Commission);
		LOG("\tCloseProfit [%.8lf]\n", pRiskSettleInvstPosition->CloseProfit);
		LOG("\tPositionProfit [%.8lf]\n", pRiskSettleInvstPosition->PositionProfit);
		LOG("\tPreSettlementPrice [%.8lf]\n", pRiskSettleInvstPosition->PreSettlementPrice);
		LOG("\tSettlementPrice [%.8lf]\n", pRiskSettleInvstPosition->SettlementPrice);
		LOG("\tOpenCost [%.8lf]\n", pRiskSettleInvstPosition->OpenCost);
		LOG("\tExchangeMargin [%.8lf]\n", pRiskSettleInvstPosition->ExchangeMargin);
		LOG("\tCloseProfitByDate [%.8lf]\n", pRiskSettleInvstPosition->CloseProfitByDate);
		LOG("\tCloseProfitByTrade [%.8lf]\n", pRiskSettleInvstPosition->CloseProfitByTrade);
		LOG("\tMarginRateByMoney [%.8lf]\n", pRiskSettleInvstPosition->MarginRateByMoney);
		LOG("\tMarginRateByVolume [%.8lf]\n", pRiskSettleInvstPosition->MarginRateByVolume);
		LOG("\tStrikeFrozenAmount [%.8lf]\n", pRiskSettleInvstPosition->StrikeFrozenAmount);
		LOG("\tPositionCostOffset [%.8lf]\n", pRiskSettleInvstPosition->PositionCostOffset);
		LOG("\tTasPositionCost [%.8lf]\n", pRiskSettleInvstPosition->TasPositionCost);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRiskSettleProductStatus>\n");
	if (pRiskSettleProductStatus)
	{
		LOG("\tExchangeID [%s]\n", pRiskSettleProductStatus->ExchangeID);
		LOG("\tProductID [%s]\n", pRiskSettleProductStatus->ProductID);
		LOG("\tProductStatus [%c]\n", pRiskSettleProductStatus->ProductStatus);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQrySPBMFutureParameter>\n");
	if (pSPBMFutureParameter)
	{
		LOG("\tTradingDay [%s]\n", pSPBMFutureParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pSPBMFutureParameter->ExchangeID);
		LOG("\tInstrumentID [%s]\n", pSPBMFutureParameter->InstrumentID);
		LOG("\tProdFamilyCode [%s]\n", pSPBMFutureParameter->ProdFamilyCode);
		LOG("\tCvf [%d]\n", pSPBMFutureParameter->Cvf);
		LOG("\tTimeRange [%c]\n", pSPBMFutureParameter->TimeRange);
		LOG("\tMarginRate [%.8lf]\n", pSPBMFutureParameter->MarginRate);
		LOG("\tLockRateX [%.8lf]\n", pSPBMFutureParameter->LockRateX);
		LOG("\tAddOnRate [%.8lf]\n", pSPBMFutureParameter->AddOnRate);
		LOG("\tPreSettlementPrice [%.8lf]\n", pSPBMFutureParameter->PreSettlementPrice);
		LOG("\tAddOnLockRateX2 [%.8lf]\n", pSPBMFutureParameter->AddOnLockRateX2);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQrySPBMOptionParameter>\n");
	if (pSPBMOptionParameter)
	{
		LOG("\tTradingDay [%s]\n", pSPBMOptionParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pSPBMOptionParameter->ExchangeID);
		LOG("\tInstrumentID [%s]\n", pSPBMOptionParameter->InstrumentID);
		LOG("\tProdFamilyCode [%s]\n", pSPBMOptionParameter->ProdFamilyCode);
		LOG("\tCvf [%d]\n", pSPBMOptionParameter->Cvf);
		LOG("\tDownPrice [%.8lf]\n", pSPBMOptionParameter->DownPrice);
		LOG("\tDelta [%.8lf]\n", pSPBMOptionParameter->Delta);
		LOG("\tSlimiDelta [%.8lf]\n", pSPBMOptionParameter->SlimiDelta);
		LOG("\tPreSettlementPrice [%.8lf]\n", pSPBMOptionParameter->PreSettlementPrice);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQrySPBMIntraParameter>\n");
	if (pSPBMIntraParameter)
	{
		LOG("\tTradingDay [%s]\n", pSPBMIntraParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pSPBMIntraParameter->ExchangeID);
		LOG("\tProdFamilyCode [%s]\n", pSPBMIntraParameter->ProdFamilyCode);
		LOG("\tIntraRateY [%.8lf]\n", pSPBMIntraParameter->IntraRateY);
		LOG("\tAddOnIntraRateY2 [%.8lf]\n", pSPBMIntraParameter->AddOnIntraRateY2);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQrySPBMInterParameter>\n");
	if (pSPBMInterParameter)
	{
		LOG("\tTradingDay [%s]\n", pSPBMInterParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pSPBMInterParameter->ExchangeID);
		LOG("\tLeg1ProdFamilyCode [%s]\n", pSPBMInterParameter->Leg1ProdFamilyCode);
		LOG("\tLeg2ProdFamilyCode [%s]\n", pSPBMInterParameter->Leg2ProdFamilyCode);
		LOG("\tSpreadId [%d]\n", pSPBMInterParameter->SpreadId);
		LOG("\tInterRateZ [%.8lf]\n", pSPBMInterParameter->InterRateZ);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQrySPBMPortfDefinition>\n");
	if (pSPBMPortfDefinition)
	{
		LOG("\tExchangeID [%s]\n", pSPBMPortfDefinition->ExchangeID);
		LOG("\tProdFamilyCode [%s]\n", pSPBMPortfDefinition->ProdFamilyCode);
		LOG("\tPortfolioDefID [%d]\n", pSPBMPortfDefinition->PortfolioDefID);
		LOG("\tIsSPBM [%d]\n", pSPBMPortfDefinition->IsSPBM);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQrySPBMInvestorPortfDef>\n");
	if (pSPBMInvestorPortfDef)
	{
		LOG("\tExchangeID [%s]\n", pSPBMInvestorPortfDef->ExchangeID);
		LOG("\tBrokerID [%s]\n", pSPBMInvestorPortfDef->BrokerID);
		LOG("\tInvestorID [%s]\n", pSPBMInvestorPortfDef->InvestorID);
		LOG("\tPortfolioDefID [%d]\n", pSPBMInvestorPortfDef->PortfolioDefID);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryInvestorPortfMarginRatio>\n");
	if (pInvestorPortfMarginRatio)
	{
		LOG("\tBrokerID [%s]\n", pInvestorPortfMarginRatio->BrokerID);
		LOG("\tInvestorID [%s]\n", pInvestorPortfMarginRatio->InvestorID);
		LOG("\tExchangeID [%s]\n", pInvestorPortfMarginRatio->ExchangeID);
		LOG("\tProductGroupID [%s]\n", pInvestorPortfMarginRatio->ProductGroupID);
		LOG("\tInvestorRange [%c]\n", pInvestorPortfMarginRatio->InvestorRange);
		LOG("\tMarginRatio [%.8lf]\n", pInvestorPortfMarginRatio->MarginRatio);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryInvestorProdSPBMDetail>\n");
	if (pInvestorProdSPBMDetail)
	{
		LOG("\tExchangeID [%s]\n", pInvestorProdSPBMDetail->ExchangeID);
		LOG("\tBrokerID [%s]\n", pInvestorProdSPBMDetail->BrokerID);
		LOG("\tInvestorID [%s]\n", pInvestorProdSPBMDetail->InvestorID);
		LOG("\tProdFamilyCode [%s]\n", pInvestorProdSPBMDetail->ProdFamilyCode);
		LOG("\tIntraInstrMargin [%.8lf]\n", pInvestorProdSPBMDetail->IntraInstrMargin);
		LOG("\tBCollectingMargin [%.8lf]\n", pInvestorProdSPBMDetail->BCollectingMargin);
		LOG("\tSCollectingMargin [%.8lf]\n", pInvestorProdSPBMDetail->SCollectingMargin);
		LOG("\tIntraProdMargin [%.8lf]\n", pInvestorProdSPBMDetail->IntraProdMargin);
		LOG("\tNetMargin [%.8lf]\n", pInvestorProdSPBMDetail->NetMargin);
		LOG("\tInterProdMargin [%.8lf]\n", pInvestorProdSPBMDetail->InterProdMargin);
		LOG("\tSingleMargin [%.8lf]\n", pInvestorProdSPBMDetail->SingleMargin);
		LOG("\tAddOnMargin [%.8lf]\n", pInvestorProdSPBMDetail->AddOnMargin);
		LOG("\tDeliveryMargin [%.8lf]\n", pInvestorProdSPBMDetail->DeliveryMargin);
		LOG("\tCallOptionMinRisk [%.8lf]\n", pInvestorProdSPBMDetail->CallOptionMinRisk);
		LOG("\tPutOptionMinRisk [%.8lf]\n", pInvestorProdSPBMDetail->PutOptionMinRisk);
		LOG("\tOptionMinRisk [%.8lf]\n", pInvestorProdSPBMDetail->OptionMinRisk);
		LOG("\tOptionValueOffset [%.8lf]\n", pInvestorProdSPBMDetail->OptionValueOffset);
		LOG("\tOptionRoyalty [%.8lf]\n", pInvestorProdSPBMDetail->OptionRoyalty);
		LOG("\tRealOptionValueOffset [%.8lf]\n", pInvestorProdSPBMDetail->RealOptionValueOffset);
		LOG("\tMargin [%.8lf]\n", pInvestorProdSPBMDetail->Margin);
		LOG("\tExchMargin [%.8lf]\n", pInvestorProdSPBMDetail->ExchMargin);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryInvestorCommoditySPMMMargin>\n");
	if (pInvestorCommoditySPMMMargin)
	{
		LOG("\tExchangeID [%s]\n", pInvestorCommoditySPMMMargin->ExchangeID);
		LOG("\tBrokerID [%s]\n", pInvestorCommoditySPMMMargin->BrokerID);
		LOG("\tInvestorID [%s]\n", pInvestorCommoditySPMMMargin->InvestorID);
		LOG("\tCommodityID [%s]\n", pInvestorCommoditySPMMMargin->CommodityID);
		LOG("\tMarginBeforeDiscount [%.8lf]\n", pInvestorCommoditySPMMMargin->MarginBeforeDiscount);
		LOG("\tMarginNoDiscount [%.8lf]\n", pInvestorCommoditySPMMMargin->MarginNoDiscount);
		LOG("\tLongPosRisk [%.8lf]\n", pInvestorCommoditySPMMMargin->LongPosRisk);
		LOG("\tLongOpenFrozenRisk [%.8lf]\n", pInvestorCommoditySPMMMargin->LongOpenFrozenRisk);
		LOG("\tLongCloseFrozenRisk [%.8lf]\n", pInvestorCommoditySPMMMargin->LongCloseFrozenRisk);
		LOG("\tShortPosRisk [%.8lf]\n", pInvestorCommoditySPMMMargin->ShortPosRisk);
		LOG("\tShortOpenFrozenRisk [%.8lf]\n", pInvestorCommoditySPMMMargin->ShortOpenFrozenRisk);
		LOG("\tShortCloseFrozenRisk [%.8lf]\n", pInvestorCommoditySPMMMargin->ShortCloseFrozenRisk);
		LOG("\tIntraCommodityRate [%.8lf]\n", pInvestorCommoditySPMMMargin->IntraCommodityRate);
		LOG("\tOptionDiscountRate [%.8lf]\n", pInvestorCommoditySPMMMargin->OptionDiscountRate);
		LOG("\tPosDiscount [%.8lf]\n", pInvestorCommoditySPMMMargin->PosDiscount);
		LOG("\tOpenFrozenDiscount [%.8lf]\n", pInvestorCommoditySPMMMargin->OpenFrozenDiscount);
		LOG("\tNetRisk [%.8lf]\n", pInvestorCommoditySPMMMargin->NetRisk);
		LOG("\tCloseFrozenMargin [%.8lf]\n", pInvestorCommoditySPMMMargin->CloseFrozenMargin);
		LOG("\tFrozenCommission [%.8lf]\n", pInvestorCommoditySPMMMargin->FrozenCommission);
		LOG("\tCommission [%.8lf]\n", pInvestorCommoditySPMMMargin->Commission);
		LOG("\tFrozenCash [%.8lf]\n", pInvestorCommoditySPMMMargin->FrozenCash);
		LOG("\tCashIn [%.8lf]\n", pInvestorCommoditySPMMMargin->CashIn);
		LOG("\tStrikeFrozenMargin [%.8lf]\n", pInvestorCommoditySPMMMargin->StrikeFrozenMargin);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryInvestorCommodityGroupSPMMMargin>\n");
	if (pInvestorCommodityGroupSPMMMargin)
	{
		LOG("\tExchangeID [%s]\n", pInvestorCommodityGroupSPMMMargin->ExchangeID);
		LOG("\tBrokerID [%s]\n", pInvestorCommodityGroupSPMMMargin->BrokerID);
		LOG("\tInvestorID [%s]\n", pInvestorCommodityGroupSPMMMargin->InvestorID);
		LOG("\tCommodityGroupID [%s]\n", pInvestorCommodityGroupSPMMMargin->CommodityGroupID);
		LOG("\tMarginBeforeDiscount [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->MarginBeforeDiscount);
		LOG("\tMarginNoDiscount [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->MarginNoDiscount);
		LOG("\tLongRisk [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->LongRisk);
		LOG("\tShortRisk [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->ShortRisk);
		LOG("\tCloseFrozenMargin [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->CloseFrozenMargin);
		LOG("\tInterCommodityRate [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->InterCommodityRate);
		LOG("\tMiniMarginRatio [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->MiniMarginRatio);
		LOG("\tAdjustRatio [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->AdjustRatio);
		LOG("\tIntraCommodityDiscount [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->IntraCommodityDiscount);
		LOG("\tInterCommodityDiscount [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->InterCommodityDiscount);
		LOG("\tExchMargin [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->ExchMargin);
		LOG("\tInvestorMargin [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->InvestorMargin);
		LOG("\tFrozenCommission [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->FrozenCommission);
		LOG("\tCommission [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->Commission);
		LOG("\tFrozenCash [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->FrozenCash);
		LOG("\tCashIn [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->CashIn);
		LOG("\tStrikeFrozenMargin [%.8lf]\n", pInvestorCommodityGroupSPMMMargin->StrikeFrozenMargin);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQrySPMMInstParam>\n");
	if (pSPMMInstParam)
	{
		LOG("\tExchangeID [%s]\n", pSPMMInstParam->ExchangeID);
		LOG("\tInstrumentID [%s]\n", pSPMMInstParam->InstrumentID);
		LOG("\tCommodityID [%s]\n", pSPMMInstParam->CommodityID);
		LOG("\tCommodityGroupID [%s]\n", pSPMMInstParam->CommodityGroupID);
		LOG("\tInstMarginCalID [%c]\n", pSPMMInstParam->InstMarginCalID);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQrySPMMProductParam>\n");
	if (pSPMMProductParam)
	{
		LOG("\tExchangeID [%s]\n", pSPMMProductParam->ExchangeID);
		LOG("\tProductID [%s]\n", pSPMMProductParam->ProductID);
		LOG("\tCommodityID [%s]\n", pSPMMProductParam->CommodityID);
		LOG("\tCommodityGroupID [%s]\n", pSPMMProductParam->CommodityGroupID);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQrySPBMAddOnInterParameter>\n");
	if (pSPBMAddOnInterParameter)
	{
		LOG("\tTradingDay [%s]\n", pSPBMAddOnInterParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pSPBMAddOnInterParameter->ExchangeID);
		LOG("\tLeg1ProdFamilyCode [%s]\n", pSPBMAddOnInterParameter->Leg1ProdFamilyCode);
		LOG("\tLeg2ProdFamilyCode [%s]\n", pSPBMAddOnInterParameter->Leg2ProdFamilyCode);
		LOG("\tSpreadId [%d]\n", pSPBMAddOnInterParameter->SpreadId);
		LOG("\tAddOnInterRateZ2 [%.8lf]\n", pSPBMAddOnInterParameter->AddOnInterRateZ2);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRCAMSCombProductInfo>\n");
	if (pRCAMSCombProductInfo)
	{
		LOG("\tTradingDay [%s]\n", pRCAMSCombProductInfo->TradingDay);
		LOG("\tExchangeID [%s]\n", pRCAMSCombProductInfo->ExchangeID);
		LOG("\tProductID [%s]\n", pRCAMSCombProductInfo->ProductID);
		LOG("\tCombProductID [%s]\n", pRCAMSCombProductInfo->CombProductID);
		LOG("\tProductGroupID [%s]\n", pRCAMSCombProductInfo->ProductGroupID);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRCAMSInstrParameter>\n");
	if (pRCAMSInstrParameter)
	{
		LOG("\tTradingDay [%s]\n", pRCAMSInstrParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pRCAMSInstrParameter->ExchangeID);
		LOG("\tProductID [%s]\n", pRCAMSInstrParameter->ProductID);
		LOG("\tHedgeRate [%.8lf]\n", pRCAMSInstrParameter->HedgeRate);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRCAMSIntraParameter>\n");
	if (pRCAMSIntraParameter)
	{
		LOG("\tTradingDay [%s]\n", pRCAMSIntraParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pRCAMSIntraParameter->ExchangeID);
		LOG("\tCombProductID [%s]\n", pRCAMSIntraParameter->CombProductID);
		LOG("\tHedgeRate [%.8lf]\n", pRCAMSIntraParameter->HedgeRate);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRCAMSInterParameter>\n");
	if (pRCAMSInterParameter)
	{
		LOG("\tTradingDay [%s]\n", pRCAMSInterParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pRCAMSInterParameter->ExchangeID);
		LOG("\tProductGroupID [%s]\n", pRCAMSInterParameter->ProductGroupID);
		LOG("\tCombProduct1 [%s]\n", pRCAMSInterParameter->CombProduct1);
		LOG("\tCombProduct2 [%s]\n", pRCAMSInterParameter->CombProduct2);
		LOG("\tPriority [%d]\n", pRCAMSInterParameter->Priority);
		LOG("\tCreditRate [%.8lf]\n", pRCAMSInterParameter->CreditRate);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRCAMSShortOptAdjustParam>\n");
	if (pRCAMSShortOptAdjustParam)
	{
		LOG("\tTradingDay [%s]\n", pRCAMSShortOptAdjustParam->TradingDay);
		LOG("\tExchangeID [%s]\n", pRCAMSShortOptAdjustParam->ExchangeID);
		LOG("\tCombProductID [%s]\n", pRCAMSShortOptAdjustParam->CombProductID);
		LOG("\tHedgeFlag [%c]\n", pRCAMSShortOptAdjustParam->HedgeFlag);
		LOG("\tAdjustValue [%.8lf]\n", pRCAMSShortOptAdjustParam->AdjustValue);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRCAMSInvestorCombPosition>\n");
	if (pRCAMSInvestorCombPosition)
	{
		LOG("\tExchangeID [%s]\n", pRCAMSInvestorCombPosition->ExchangeID);
		LOG("\tBrokerID [%s]\n", pRCAMSInvestorCombPosition->BrokerID);
		LOG("\tInvestorID [%s]\n", pRCAMSInvestorCombPosition->InvestorID);
		LOG("\tInstrumentID [%s]\n", pRCAMSInvestorCombPosition->InstrumentID);
		LOG("\tCombInstrumentID [%s]\n", pRCAMSInvestorCombPosition->CombInstrumentID);
		LOG("\tExchangeInstID [%s]\n", pRCAMSInvestorCombPosition->ExchangeInstID);
		LOG("\tLegID [%d]\n", pRCAMSInvestorCombPosition->LegID);
		LOG("\tTotalAmt [%d]\n", pRCAMSInvestorCombPosition->TotalAmt);
		LOG("\tHedgeFlag [%c]\n", pRCAMSInvestorCombPosition->HedgeFlag);
		LOG("\tPosiDirection [%c]\n", pRCAMSInvestorCombPosition->PosiDirection);
		LOG("\tExchMargin [%.8lf]\n", pRCAMSInvestorCombPosition->ExchMargin);
		LOG("\tMargin [%.8lf]\n", pRCAMSInvestorCombPosition->Margin);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryInvestorProdRCAMSMargin>\n");
	if (pInvestorProdRCAMSMargin)
	{
		LOG("\tExchangeID [%s]\n", pInvestorProdRCAMSMargin->ExchangeID);
		LOG("\tBrokerID [%s]\n", pInvestorProdRCAMSMargin->BrokerID);
		LOG("\tInvestorID [%s]\n", pInvestorProdRCAMSMargin->InvestorID);
		LOG("\tCombProductID [%s]\n", pInvestorProdRCAMSMargin->CombProductID);
		LOG("\tProductGroupID [%s]\n", pInvestorProdRCAMSMargin->ProductGroupID);
		LOG("\tHedgeFlag [%c]\n", pInvestorProdRCAMSMargin->HedgeFlag);
		LOG("\tRiskBeforeDiscount [%.8lf]\n", pInvestorProdRCAMSMargin->RiskBeforeDiscount);
		LOG("\tIntraInstrRisk [%.8lf]\n", pInvestorProdRCAMSMargin->IntraInstrRisk);
		LOG("\tBPosRisk [%.8lf]\n", pInvestorProdRCAMSMargin->BPosRisk);
		LOG("\tSPosRisk [%.8lf]\n", pInvestorProdRCAMSMargin->SPosRisk);
		LOG("\tIntraProdRisk [%.8lf]\n", pInvestorProdRCAMSMargin->IntraProdRisk);
		LOG("\tNetRisk [%.8lf]\n", pInvestorProdRCAMSMargin->NetRisk);
		LOG("\tInterProdRisk [%.8lf]\n", pInvestorProdRCAMSMargin->InterProdRisk);
		LOG("\tShortOptRiskAdj [%.8lf]\n", pInvestorProdRCAMSMargin->ShortOptRiskAdj);
		LOG("\tOptionRoyalty [%.8lf]\n", pInvestorProdRCAMSMargin->OptionRoyalty);
		LOG("\tMMSACloseFrozenMargin [%.8lf]\n", pInvestorProdRCAMSMargin->MMSACloseFrozenMargin);
		LOG("\tCloseCombFrozenMargin [%.8lf]\n", pInvestorProdRCAMSMargin->CloseCombFrozenMargin);
		LOG("\tCloseFrozenMargin [%.8lf]\n", pInvestorProdRCAMSMargin->CloseFrozenMargin);
		LOG("\tMMSAOpenFrozenMargin [%.8lf]\n", pInvestorProdRCAMSMargin->MMSAOpenFrozenMargin);
		LOG("\tDeliveryOpenFrozenMargin [%.8lf]\n", pInvestorProdRCAMSMargin->DeliveryOpenFrozenMargin);
		LOG("\tOpenFrozenMargin [%.8lf]\n", pInvestorProdRCAMSMargin->OpenFrozenMargin);
		LOG("\tUseFrozenMargin [%.8lf]\n", pInvestorProdRCAMSMargin->UseFrozenMargin);
		LOG("\tMMSAExchMargin [%.8lf]\n", pInvestorProdRCAMSMargin->MMSAExchMargin);
		LOG("\tDeliveryExchMargin [%.8lf]\n", pInvestorProdRCAMSMargin->DeliveryExchMargin);
		LOG("\tCombExchMargin [%.8lf]\n", pInvestorProdRCAMSMargin->CombExchMargin);
		LOG("\tExchMargin [%.8lf]\n", pInvestorProdRCAMSMargin->ExchMargin);
		LOG("\tUseMargin [%.8lf]\n", pInvestorProdRCAMSMargin->UseMargin);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRULEInstrParameter>\n");
	if (pRULEInstrParameter)
	{
		LOG("\tTradingDay [%s]\n", pRULEInstrParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pRULEInstrParameter->ExchangeID);
		LOG("\tInstrumentID [%s]\n", pRULEInstrParameter->InstrumentID);
		LOG("\tStdInstrumentID [%s]\n", pRULEInstrParameter->StdInstrumentID);
		LOG("\tCommodityGroupID [%d]\n", pRULEInstrParameter->CommodityGroupID);
		LOG("\tInstrumentClass [%c]\n", pRULEInstrParameter->InstrumentClass);
		LOG("\tBSpecRatio [%.8lf]\n", pRULEInstrParameter->BSpecRatio);
		LOG("\tSSpecRatio [%.8lf]\n", pRULEInstrParameter->SSpecRatio);
		LOG("\tBHedgeRatio [%.8lf]\n", pRULEInstrParameter->BHedgeRatio);
		LOG("\tSHedgeRatio [%.8lf]\n", pRULEInstrParameter->SHedgeRatio);
		LOG("\tBAddOnMargin [%.8lf]\n", pRULEInstrParameter->BAddOnMargin);
		LOG("\tSAddOnMargin [%.8lf]\n", pRULEInstrParameter->SAddOnMargin);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRULEIntraParameter>\n");
	if (pRULEIntraParameter)
	{
		LOG("\tTradingDay [%s]\n", pRULEIntraParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pRULEIntraParameter->ExchangeID);
		LOG("\tProdFamilyCode [%s]\n", pRULEIntraParameter->ProdFamilyCode);
		LOG("\tStdInstrumentID [%s]\n", pRULEIntraParameter->StdInstrumentID);
		LOG("\tStdInstrMargin [%.8lf]\n", pRULEIntraParameter->StdInstrMargin);
		LOG("\tUsualIntraRate [%.8lf]\n", pRULEIntraParameter->UsualIntraRate);
		LOG("\tDeliveryIntraRate [%.8lf]\n", pRULEIntraParameter->DeliveryIntraRate);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryRULEInterParameter>\n");
	if (pRULEInterParameter)
	{
		LOG("\tTradingDay [%s]\n", pRULEInterParameter->TradingDay);
		LOG("\tExchangeID [%s]\n", pRULEInterParameter->ExchangeID);
		LOG("\tLeg1ProdFamilyCode [%s]\n", pRULEInterParameter->Leg1ProdFamilyCode);
		LOG("\tLeg2ProdFamilyCode [%s]\n", pRULEInterParameter->Leg2ProdFamilyCode);
		LOG("\tCommodityGroupName [%s]\n", pRULEInterParameter->CommodityGroupName);
		LOG("\tSpreadId [%d]\n", pRULEInterParameter->SpreadId);
		LOG("\tLeg1PropFactor [%d]\n", pRULEInterParameter->Leg1PropFactor);
		LOG("\tLeg2PropFactor [%d]\n", pRULEInterParameter->Leg2PropFactor);
		LOG("\tCommodityGroupID [%d]\n", pRULEInterParameter->CommodityGroupID);
		LOG("\tInterRate [%.8lf]\n", pRULEInterParameter->InterRate);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
{
	LOG("<OnRspQryInvestorProdRULEMargin>\n");
	if (pInvestorProdRULEMargin)
	{
		LOG("\tExchangeID [%s]\n", pInvestorProdRULEMargin->ExchangeID);
		LOG("\tBrokerID [%s]\n", pInvestorProdRULEMargin->BrokerID);
		LOG("\tInvestorID [%s]\n", pInvestorProdRULEMargin->InvestorID);
		LOG("\tProdFamilyCode [%s]\n", pInvestorProdRULEMargin->ProdFamilyCode);
		LOG("\tCommodityGroupID [%d]\n", pInvestorProdRULEMargin->CommodityGroupID);
		LOG("\tInstrumentClass [%c]\n", pInvestorProdRULEMargin->InstrumentClass);
		LOG("\tBStdPosition [%.8lf]\n", pInvestorProdRULEMargin->BStdPosition);
		LOG("\tSStdPosition [%.8lf]\n", pInvestorProdRULEMargin->SStdPosition);
		LOG("\tBStdOpenFrozen [%.8lf]\n", pInvestorProdRULEMargin->BStdOpenFrozen);
		LOG("\tSStdOpenFrozen [%.8lf]\n", pInvestorProdRULEMargin->SStdOpenFrozen);
		LOG("\tBStdCloseFrozen [%.8lf]\n", pInvestorProdRULEMargin->BStdCloseFrozen);
		LOG("\tSStdCloseFrozen [%.8lf]\n", pInvestorProdRULEMargin->SStdCloseFrozen);
		LOG("\tIntraProdStdPosition [%.8lf]\n", pInvestorProdRULEMargin->IntraProdStdPosition);
		LOG("\tNetStdPosition [%.8lf]\n", pInvestorProdRULEMargin->NetStdPosition);
		LOG("\tInterProdStdPosition [%.8lf]\n", pInvestorProdRULEMargin->InterProdStdPosition);
		LOG("\tSingleStdPosition [%.8lf]\n", pInvestorProdRULEMargin->SingleStdPosition);
		LOG("\tIntraProdMargin [%.8lf]\n", pInvestorProdRULEMargin->IntraProdMargin);
		LOG("\tInterProdMargin [%.8lf]\n", pInvestorProdRULEMargin->InterProdMargin);
		LOG("\tSingleMargin [%.8lf]\n", pInvestorProdRULEMargin->SingleMargin);
		LOG("\tNonCombMargin [%.8lf]\n", pInvestorProdRULEMargin->NonCombMargin);
		LOG("\tAddOnMargin [%.8lf]\n", pInvestorProdRULEMargin->AddOnMargin);
		LOG("\tExchMargin [%.8lf]\n", pInvestorProdRULEMargin->ExchMargin);
		LOG("\tAddOnFrozenMargin [%.8lf]\n", pInvestorProdRULEMargin->AddOnFrozenMargin);
		LOG("\tOpenFrozenMargin [%.8lf]\n", pInvestorProdRULEMargin->OpenFrozenMargin);
		LOG("\tCloseFrozenMargin [%.8lf]\n", pInvestorProdRULEMargin->CloseFrozenMargin);
		LOG("\tMargin [%.8lf]\n", pInvestorProdRULEMargin->Margin);
		LOG("\tFrozenMargin [%.8lf]\n", pInvestorProdRULEMargin->FrozenMargin);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
void CTraderSpi::OnRspQryInvestorPortfSetting(CThostFtdcInvestorPortfSettingField* pInvestorPortfSetting, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	LOG("<OnRspQryInvestorPortfSetting>\n");
	if (pInvestorPortfSetting)
	{
		LOG("\tExchangeID [%s]\n", pInvestorPortfSetting->ExchangeID);
		LOG("\tBrokerID [%s]\n", pInvestorPortfSetting->BrokerID);
		LOG("\tInvestorID [%s]\n", pInvestorPortfSetting->InvestorID);
		LOG("\tUsePortf [%d]\n", pInvestorPortfSetting->UsePortf);
		LOG("\tHedgeFlag [%c]\n", pInvestorPortfSetting->HedgeFlag);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
void CTraderSpi::OnRspQryInvestorInfoCommRec(CThostFtdcInvestorInfoCommRecField* pInvestorInfoCommRec, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	LOG("<OnRspQryInvestorInfoCommRec>\n");
	if (pInvestorInfoCommRec)
	{
		LOG("\tExchangeID [%s]\n", pInvestorInfoCommRec->ExchangeID);
		LOG("\tBrokerID [%s]\n", pInvestorInfoCommRec->BrokerID);
		LOG("\tInvestorID [%s]\n", pInvestorInfoCommRec->InvestorID);
		LOG("\tInstrumentID [%s]\n", pInvestorInfoCommRec->InstrumentID);
		LOG("\tProductID [%s]\n", pInvestorInfoCommRec->ProductID);
		LOG("\tOrderCount [%d]\n", pInvestorInfoCommRec->OrderCount);
		LOG("\tOrderActionCount [%d]\n", pInvestorInfoCommRec->OrderActionCount);
		LOG("\tForQuoteCnt [%d]\n", pInvestorInfoCommRec->ForQuoteCnt);
		LOG("\tIsOptSeries [%d]\n", pInvestorInfoCommRec->IsOptSeries);
		LOG("\tInfoCnt [%d]\n", pInvestorInfoCommRec->InfoCnt);
		LOG("\tInfoComm [%.8lf]\n", pInvestorInfoCommRec->InfoComm);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
void CTraderSpi::OnRspQryCombLeg(CThostFtdcCombLegField* pCombLeg, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	LOG("<OnRspQryCombLeg>\n");
	if (pCombLeg)
	{
		LOG("\tCombInstrumentID [%s]\n", pCombLeg->CombInstrumentID);
		LOG("\tLegInstrumentID [%s]\n", pCombLeg->LegInstrumentID);
		LOG("\tLegID [%d]\n", pCombLeg->LegID);
		LOG("\tLegMultiple [%d]\n", pCombLeg->LegMultiple);
		LOG("\tImplyLevel [%d]\n", pCombLeg->ImplyLevel);
		LOG("\tDirection [%c]\n", pCombLeg->Direction);
	}
	if (pRspInfo)
...
void CTraderSpi::OnRspOffsetSetting(CThostFtdcInputOffsetSettingField* pInputOffsetSetting, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	LOG("<OnRspOffsetSetting>\n");
	if (pInputOffsetSetting)
	{
		LOG("\tBrokerID [%s]\n", pInputOffsetSetting->BrokerID);
		LOG("\tInvestorID [%s]\n", pInputOffsetSetting->InvestorID);
		LOG("\tInstrumentID [%s]\n", pInputOffsetSetting->InstrumentID);
		LOG("\tUnderlyingInstrID [%s]\n", pInputOffsetSetting->UnderlyingInstrID);
		LOG("\tProductID [%s]\n", pInputOffsetSetting->ProductID);
		LOG("\tUserID [%s]\n", pInputOffsetSetting->UserID);
		LOG("\tExchangeID [%s]\n", pInputOffsetSetting->ExchangeID);
		LOG("\tIPAddress [%s]\n", pInputOffsetSetting->IPAddress);
		LOG("\tMacAddress [%s]\n", pInputOffsetSetting->MacAddress);
		LOG("\tVolume [%d]\n", pInputOffsetSetting->Volume);
		LOG("\tIsOffset [%d]\n", pInputOffsetSetting->IsOffset);
		LOG("\tRequestID [%d]\n", pInputOffsetSetting->RequestID);
		LOG("\tOffsetType [%c]\n", pInputOffsetSetting->OffsetType);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
void CTraderSpi::OnRspCancelOffsetSetting(CThostFtdcInputOffsetSettingField* pInputOffsetSetting, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	LOG("<OnRspCancelOffsetSetting>\n");
	if (pInputOffsetSetting)
	{
		LOG("\tBrokerID [%s]\n", pInputOffsetSetting->BrokerID);
		LOG("\tInvestorID [%s]\n", pInputOffsetSetting->InvestorID);
...
{
	LOG("<OnRtnOffsetSetting>\n");
	if (pOffsetSetting)
	{
		LOG("\tBrokerID [%s]\n", pOffsetSetting->BrokerID);
		LOG("\tInvestorID [%s]\n", pOffsetSetting->InvestorID);
		LOG("\tInstrumentID [%s]\n", pOffsetSetting->InstrumentID);
		LOG("\tUnderlyingInstrID [%s]\n", pOffsetSetting->UnderlyingInstrID);
		LOG("\tProductID [%s]\n", pOffsetSetting->ProductID);
		LOG("\tUserID [%s]\n", pOffsetSetting->UserID);
		LOG("\tExchangeID [%s]\n", pOffsetSetting->ExchangeID);
		LOG("\tIPAddress [%s]\n", pOffsetSetting->IPAddress);
		LOG("\tMacAddress [%s]\n", pOffsetSetting->MacAddress);
		LOG("\tExchangeInstID [%s]\n", pOffsetSetting->ExchangeInstID);
		LOG("\tExchangeSerialNo [%s]\n", pOffsetSetting->ExchangeSerialNo);
		LOG("\tExchangeProductID [%s]\n", pOffsetSetting->ExchangeProductID);
		LOG("\tParticipantID [%s]\n", pOffsetSetting->ParticipantID);
		LOG("\tClientID [%s]\n", pOffsetSetting->ClientID);
		LOG("\tTraderID [%s]\n", pOffsetSetting->TraderID);
		LOG("\tTradingDay [%s]\n", pOffsetSetting->TradingDay);
		LOG("\tInsertDate [%s]\n", pOffsetSetting->InsertDate);
		LOG("\tInsertTime [%s]\n", pOffsetSetting->InsertTime);
		LOG("\tCancelTime [%s]\n", pOffsetSetting->CancelTime);
		LOG("\tStatusMsg [%s]\n", pOffsetSetting->StatusMsg);
		LOG("\tActiveUserID [%s]\n", pOffsetSetting->ActiveUserID);
		LOG("\tVolume [%d]\n", pOffsetSetting->Volume);
		LOG("\tIsOffset [%d]\n", pOffsetSetting->IsOffset);
		LOG("\tRequestID [%d]\n", pOffsetSetting->RequestID);
		LOG("\tInstallID [%d]\n", pOffsetSetting->InstallID);
		LOG("\tSettlementID [%d]\n", pOffsetSetting->SettlementID);
		LOG("\tSequenceNo [%d]\n", pOffsetSetting->SequenceNo);
		LOG("\tFrontID [%d]\n", pOffsetSetting->FrontID);
		LOG("\tSessionID [%d]\n", pOffsetSetting->SessionID);
		LOG("\tBrokerOffsetSettingSeq [%d]\n", pOffsetSetting->BrokerOffsetSettingSeq);
		LOG("\tOffsetType [%c]\n", pOffsetSetting->OffsetType);
		LOG("\tOrderSubmitStatus [%c]\n", pOffsetSetting->OrderSubmitStatus);
		LOG("\tExecResult [%c]\n", pOffsetSetting->ExecResult);
		LOG("\tApplySrc [%c]\n", pOffsetSetting->ApplySrc);
	}
	LOG("</OnRtnOffsetSetting>\n");
};
...
{
	LOG("<OnErrRtnCancelOffsetSetting>\n");
	if (pCancelOffsetSetting)
	{
		LOG("\tBrokerID [%s]\n", pCancelOffsetSetting->BrokerID);
		LOG("\tInvestorID [%s]\n", pCancelOffsetSetting->InvestorID);
		LOG("\tInstrumentID [%s]\n", pCancelOffsetSetting->InstrumentID);
		LOG("\tUnderlyingInstrID [%s]\n", pCancelOffsetSetting->UnderlyingInstrID);
		LOG("\tProductID [%s]\n", pCancelOffsetSetting->ProductID);
		LOG("\tUserID [%s]\n", pCancelOffsetSetting->UserID);
		LOG("\tExchangeID [%s]\n", pCancelOffsetSetting->ExchangeID);
		LOG("\tIPAddress [%s]\n", pCancelOffsetSetting->IPAddress);
		LOG("\tMacAddress [%s]\n", pCancelOffsetSetting->MacAddress);
		LOG("\tExchangeInstID [%s]\n", pCancelOffsetSetting->ExchangeInstID);
		LOG("\tExchangeSerialNo [%s]\n", pCancelOffsetSetting->ExchangeSerialNo);
		LOG("\tExchangeProductID [%s]\n", pCancelOffsetSetting->ExchangeProductID);
		LOG("\tTraderID [%s]\n", pCancelOffsetSetting->TraderID);
		LOG("\tParticipantID [%s]\n", pCancelOffsetSetting->ParticipantID);
		LOG("\tClientID [%s]\n", pCancelOffsetSetting->ClientID);
		LOG("\tStatusMsg [%s]\n", pCancelOffsetSetting->StatusMsg);
		LOG("\tActionLocalID [%s]\n", pCancelOffsetSetting->ActionLocalID);
		LOG("\tActionDate [%s]\n", pCancelOffsetSetting->ActionDate);
		LOG("\tActionTime [%s]\n", pCancelOffsetSetting->ActionTime);
		LOG("\tVolume [%d]\n", pCancelOffsetSetting->Volume);
		LOG("\tIsOffset [%d]\n", pCancelOffsetSetting->IsOffset);
		LOG("\tRequestID [%d]\n", pCancelOffsetSetting->RequestID);
		LOG("\tInstallID [%d]\n", pCancelOffsetSetting->InstallID);
		LOG("\tOffsetType [%c]\n", pCancelOffsetSetting->OffsetType);
		LOG("\tOrderActionStatus [%c]\n", pCancelOffsetSetting->OrderActionStatus);
	}
	if (pRspInfo)
	{
		LOG("\tErrorMsg [%s]\n", pRspInfo->ErrorMsg);
...
void CTraderSpi::OnRspQryOffsetSetting(CThostFtdcOffsetSettingField* pOffsetSetting, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
	LOG("<OnRspQryOffsetSetting>\n");
	if (pOffsetSetting)
	{
		LOG("\tBrokerID [%s]\n", pOffsetSetting->BrokerID);
		LOG("\tInvestorID [%s]\n", pOffsetSetting->InvestorID);
