...
public:
	...
	///@return 创建出的UserApi
	CThostFtdcTraderApi* CreateFtdcTraderApi(const char* pszFlowPath = "", bool bIsProductionMode = true);
	...
	virtual int SubmitWechatUserSystemInfo(CThostFtdcWechatUserSystemInfoField* pUserSystemInfo);
	...
	///投资者新型组合保证金开关查询
	virtual int ReqQryInvestorPortfSetting(CThostFtdcQryInvestorPortfSettingField* pQryInvestorPortfSetting, int nRequestID);

	///投资者申报费阶梯收取记录查询
	virtual int ReqQryInvestorInfoCommRec(CThostFtdcQryInvestorInfoCommRecField* pQryInvestorInfoCommRec, int nRequestID);

	///组合腿信息查询
	virtual int ReqQryCombLeg(CThostFtdcQryCombLegField* pQryCombLeg, int nRequestID);

	///对冲设置请求
	virtual int ReqOffsetSetting(CThostFtdcInputOffsetSettingField* pInputOffsetSetting, int nRequestID);

	///对冲设置撤销请求
	virtual int ReqCancelOffsetSetting(CThostFtdcInputOffsetSettingField* pInputOffsetSetting, int nRequestID);
